...
namespace ClinicManagement.Application.Tests.Mappings
{
    public class MappingProfileTests
    {
        ...
        [Fact]
        public void MappingProfile_Configuration_ShouldNotThrowException()
        {
            // Act & Assert - Configuration should be created without throwing
            Assert.NotNull(_mapper);
            Assert.NotNull(_mapper.ConfigurationProvider);
        }
