...
namespace DBProject.DAL
{
	...
	public class myDAL
    {
        ...
        private static string GetConnectionString()
        {
            ...
            {
                return $"Host={dbServer};Database={dbName};Username={dbUser};Password={dbPassword};Port=5432";
            }
		...
		public int validateLogin (string Email, string Password, ref int type , ref int id)
        {
            ...
            try
            {
                ...
                cmd1.Parameters.Add("@status", NpgsqlDbType.Integer).Direction = ParameterDirection.Output;
                cmd1.Parameters.Add("@ID", NpgsqlDbType.Integer).Direction = ParameterDirection.Output;
                cmd1.Parameters.Add("@type", NpgsqlDbType.Integer).Direction = ParameterDirection.Output;
        ...
        public int DoctorEmailAlreadyExist(string Email)
        {
            ...
            cmd.Parameters.Add("@status", NpgsqlDbType.Integer).Direction = ParameterDirection.Output;
        ...
        public int AddStaff(string Name, string BirthDate, string Phone, char gender, string Address, int salary, string Qual, string Designation)
        {
            ...
            try
            {
                ...
                */
                ...
                cmd.Parameters.Add("@Phone", NpgsqlDbType.Varchar, 30).Value = Phone;
                cmd.Parameters.Add("@gender", NpgsqlDbType.Varchar, 1).Value = gender;
                cmd.Parameters.Add("@salary", NpgsqlDbType.Integer, 30).Value = salary;
        ...
        public int GETPATIENT(int pid, ref string name, ref string phone, ref string address, ref string birthDate, ref int age, ref string gender)
        {
            ...
            try
            {
                ...
                cmd1.Parameters.Add("@id", NpgsqlDbType.Integer).Value = pid;
                ...
                cmd1.Parameters.Add("@age", NpgsqlDbType.Integer).Direction = ParameterDirection.Output;
        ...
        public int GET_DOCTOR_PROFILE(int dID, ref string name, ref string phone, ref string gender, ref float charges_Per_Visit, ref float ReputeIndex, ref int PatientsTreated, ref string qualification, ref string specialization, ref int workE, ref int age)
        {
            ...
            try
            {
                ...
                //Inputs
                cmd1.Parameters.Add("@dID", NpgsqlDbType.Integer).Value = dID;
                ...
                cmd1.Parameters.Add("@charges", NpgsqlDbType.Double).Direction = ParameterDirection.Output;
                cmd1.Parameters.Add("@RI", NpgsqlDbType.Double).Direction = ParameterDirection.Output;
                cmd1.Parameters.Add("@PTreated", NpgsqlDbType.Integer).Direction = ParameterDirection.Output;
                ...
                cmd1.Parameters.Add("@workE", NpgsqlDbType.Integer).Direction = ParameterDirection.Output;
                cmd1.Parameters.Add("@age", NpgsqlDbType.Integer).Direction = ParameterDirection.Output;
        ...
        public int GETSATFF(int id, ref string name, ref string phone, ref string address, ref string gender, ref string desig, ref int sal)
        {
            ...
            //Inputs
            cmd1.Parameters.Add("@id", NpgsqlDbType.Integer).Value = id;
            ...
            cmd1.Parameters.Add("@sal", NpgsqlDbType.Integer).Direction = ParameterDirection.Output;
		...
		public int getBillHistory(int id, ref DataTable result)
		{
			...
			try
			{
				...
				/*INPUT*/
				cmd1.Parameters.Add("@pId", NpgsqlDbType.Integer).Value = id;

				/*OUTPUT*/
				cmd1.Parameters.Add("@count", NpgsqlDbType.Integer).Direction = ParameterDirection.Output;
		...
		public int appointmentTodayDisplayer(int pid, ref string dName, ref string timings)
		{
			...
			try
			{
                ...
                cmd1.Parameters.Add("@pid", NpgsqlDbType.Integer).Value = pid;
		...
		public int insertAppointment(int dID, int pID, int freeSlot, ref string mes)
		{
			...
			con.Notice += delegate (object sender, NpgsqlNoticeEventArgs e)
			{
			...
			try
			{
				...
				cmd1.Parameters.Add("@dID", NpgsqlDbType.Integer).Value = dID;
				cmd1.Parameters.Add("@pID", NpgsqlDbType.Integer).Value = pID;
				cmd1.Parameters.Add("@freeSlot", NpgsqlDbType.Integer).Value = freeSlot;
		...
		public int isFeedbackPending(int pid, ref string dName, ref string timings, ref int aID)
		{
			...
			try
			{
				...
				cmd1.Parameters.Add("@timings", NpgsqlDbType.Varchar, 30).Direction = ParameterDirection.Output;
				cmd1.Parameters.Add("@dName", NpgsqlDbType.Varchar, 30).Direction = ParameterDirection.Output;
				cmd1.Parameters.Add("@aID", NpgsqlDbType.Integer).Direction = ParameterDirection.Output;
		...
		public int givePendingFeedback(int aID)
		{
			...
			try
			{
				...
				//Inputs
				cmd1.Parameters.Add("@aId", NpgsqlDbType.Integer).Value = aID;
		...
		public void GetAllpendingappointments_DAL(int doctorid, ref DataTable DT)
		{
			...
			try
			{
				...
				cmd.CommandType = CommandType.StoredProcedure;
				cmd.Parameters.Add("@DOCTOR_ID", NpgsqlDbType.Integer);
		...
		public int UpdateAppointment_DAL(int Appointmentid)
		{
            ...
            try
            {
                ...
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.Add("@APPOINT_ID", NpgsqlDbType.Integer).Value = Appointmentid;
		...
		public int search_patient_DAL(int did, ref DataTable result)
		{
            ...
            try
            {
                ...
                cmd.Parameters.Add("@DOC_ID", NpgsqlDbType.Integer).Value = did;
		...
		public int update_prescription_DAL(int did, int appointid, string disease, string progres, string prescrip)
		{
			...
			try
			{
				...
				cmd.CommandType = CommandType.StoredProcedure;
				cmd.Parameters.Add("@docId", NpgsqlDbType.Integer).Value = did;
				cmd.Parameters.Add("@appointid", NpgsqlDbType.Integer).Value = appointid;
		...
		public int generate_bill_DAL(int docid, ref DataTable result)
		{
            ...
            try
            {
                ...
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.Add("@dId", NpgsqlDbType.Integer);
		...
		public void paid_bill_DAL(int did, int appoint)
		{
			...
			cmd.Parameters.Add("@docId", NpgsqlDbType.Integer).Value = did;
			cmd.Parameters.Add("@appointid", NpgsqlDbType.Integer).Value = appoint;
        ...
        public int getPHistory(int id, ref DataTable result)
        {
            ...
            try
            {
                ...
                /*INPUT*/
                cmd1.Parameters.Add("@dId", NpgsqlDbType.Integer).Value = id;
